...
- Feel free to join in and code along with me. 
  - start by cloning the repo from https://github.com/higgi13425/multipanel_patchwork
- Run the setup code chunk in the code-along Rmarkdown document.
  - multipanel_code_along.Rmd
...
- Use {reprex} to ask questions on RStudio Community (now Posit Community) and Stack Overflow
...
# Links to RStudio (Posit) Community and StackOverflow Discussions
